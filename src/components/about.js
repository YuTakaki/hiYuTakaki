          ...
          <div className='section-content'>
            <div className='myProfile'>
              <div className='myImage'>
                <img src={yu}/>
                <a href='https://drive.google.com/file/d/1RnfZQ_RaeuFXRIPJMUkIe1v-HyxZxrP8/view?usp=sharing' target='_blank'><p>View Resume</p></a>
              </div>
              <div className='me'>
